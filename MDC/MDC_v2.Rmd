---
title: "Multidisciplinary breast program in New York City - Update"
author: "Anni Liu"
...
Please notice that the value of column E (`Race Code`) for the patient with ID WCM1260 is changed from `NHW` into `NHB`. The value of column F (`Race 2`) for the patient with ID NYPQ641 is changed from `Non-Asian` into `Southeast Asian`. 
...
data_full$RaceEthnicity.1 <- gsub("Nhw|NHw", "NHW", # 3rd gsub run
                                  gsub("Asian/Indian/ Pakistani", "Asian/Indian/Pakistani", # 2nd gsub run
                                       gsub("Afghan$", "Afghani", # 1st gsub run

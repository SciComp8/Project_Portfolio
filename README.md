...
- [A pipeline that loads the preprocessed scRNAseq data, build the variational autoencoder to predict the chemical perturbation effect, evaluate the model performance]ChemicalPerturbation/Pipeline.py

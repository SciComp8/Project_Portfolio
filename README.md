...
A bioinformatics pipeline is developed to glue several steps of trimming reads from raw FASTQ files, expression quantification in the form of count data, and downstream differential gene expression analysis .

...
y.train <- mclapply(1:length(vars),
                    ...
                    mc.cores = 10L) 
# I may recommend use calcNormFactors() to convert raw library sizes into effective library sizes, before the step of estimating the trended dispersions

...
## Wrap above separate codes into one function without TMM
```{r uni_ana_noTMM_func}
uni_ana_noTMM <- function(seed.num = 999) {
  ...
  tab1 <- tbl_summary(data = dat.pheno.all,
    ...
    add_p() %>% 
    as_gt() %>%
    gt::gtsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/", date.analysis, "_", "Table1", "_", seed.num, ".rtf"))
  ...
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/noTMM/", date.analysis, "_", "BMAseq", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/noTMM/", date.analysis, "_", "voom_limma", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/noTMM/", date.analysis, "_", "voom_limma_eBayes", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/noTMM/", date.analysis, "_", "edgeR", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/noTMM/", date.analysis, "_", "DESeq2", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
uni_ana_TMM <- function(seed.num = 999) {
  ...
  tab1 <- tbl_summary(data = dat.pheno.all,
    ...
    add_p() %>% 
    as_gt() %>%
    gt::gtsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM/", date.analysis, "_", "Table1", "_", seed.num, ".rtf"))
  ...
  ##                  BMAseq univariate analysis                  ##
  ##################################################################
  output.uni.train <- BMAseq.uni.norm(dat.expr.counts = dat.expr.train, 
                                      dat.pheno = dat.pheno.train, 
                                      var.pool = vars, 
                                      cut.BF = 1, 
                                      cut.FDR = 0.25) 
  output.uni.test <- BMAseq.uni.norm(dat.expr.counts = dat.expr.test, 
                                     dat.pheno = dat.pheno.test, 
                                     var.pool = vars, 
                                     cut.BF = 1, 
                                     cut.FDR = 0.25) 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM/", date.analysis, "_", "BMAseq", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM/", date.analysis, "_", "voom_limma", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM/", date.analysis, "_", "voom_limma_eBayes", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM/", date.analysis, "_", "edgeR", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(plot.array, ncol = 3)))
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM/", date.analysis, "_", "DESeq2", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
```{r}
seed.num.vec <- c(8809678, 98907, 233, 556, 7890, 120, 2390, 778, 666, 99999)
for (i in 1:10L) {uni_ana_TMM(seed.num = seed.num.vec[i])}
```

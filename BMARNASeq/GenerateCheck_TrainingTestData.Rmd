...
save.image(file = paste0("../ApplicationData/derived/", image.date, "_checkdata_image.RData"))
```
...
BMI.eFDR.q.dat.2390 <- data.frame(Estimate = c(
  BMAseq.eFDR.Main.2000.train$BMI |> log10(),
  BMAseq.eFDR.Main.2000.test$BMI |> log10(),
  DESeq2.eFDR.2000.train$BMI |> log10(), 
  DESeq2.eFDR.2000.test$BMI |> log10(), 
  edgeR.eFDR.2000.train$BMI |> log10(), 
  edgeR.eFDR.2000.test$BMI |> log10(),
  eBayes.eFDR.2000.train$BMI |> log10(), 
  eBayes.eFDR.2000.test$BMI |> log10(),
  voom.eFDR.2000.train$BMI |> log10(), 
  voom.eFDR.2000.test$BMI |> log10()),
                                  Data.type = rep(c("Train", "Test"), each = 2000, times = 5),
                                  DEG.method = rep(c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"), each = 4000)
                                  )
BMI.eFDR.q.dat.2390$DEG.method <- factor(BMI.eFDR.q.dat.2390$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 2390
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/2390/", date.analysis, "_", "BMIMain_eFDR_qvalue", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
# date.analysis <- format(Sys.Date(), "%Y%b%d")
# model.type <- "Multi_Interaction"
# plot.type <- "violinplot"
# seed.num <- 2390
# file.path <- sprintf("../ApplicationResult/%s/RandomSeed/TMM_Top2000/%s/%s/", model.type, plot.type, seed.num)
# file.path
# paste0(file.path, date.analysis, "_", "BMIMain_eFDR_qvalue", "_", seed.num, ".png")
```
...
AGE.eFDR.q.dat.2390 <- data.frame(Estimate = c(
  BMAseq.eFDR.Main.2000.train$AGE |> log10(), 
  BMAseq.eFDR.Main.2000.test$AGE |> log10(),
  DESeq2.eFDR.2000.train$AGE |> log10(), 
  DESeq2.eFDR.2000.test$AGE |> log10(), 
  edgeR.eFDR.2000.train$AGE |> log10(), 
  edgeR.eFDR.2000.test$AGE |> log10(),
  eBayes.eFDR.2000.train$AGE |> log10(), 
  eBayes.eFDR.2000.test$AGE |> log10(),
  voom.eFDR.2000.train$AGE |> log10(), 
  voom.eFDR.2000.test$AGE |> log10()),
                                  Data.type = rep(c("Train", "Test"), each = 2000, times = 5),
                                  DEG.method = rep(c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"), each = 4000)
                                  )
AGE.eFDR.q.dat.2390$DEG.method <- factor(AGE.eFDR.q.dat.2390$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 2390
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/2390/", date.analysis, "_", "AGEMain_eFDR_qvalue", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
SEX.eFDR.q.dat.2390 <- data.frame(Estimate = c(
  BMAseq.eFDR.Main.2000.train$SEX |> log10(), 
  BMAseq.eFDR.Main.2000.test$SEX |> log10(),
  DESeq2.eFDR.2000.train$SEX |> log10(), 
  DESeq2.eFDR.2000.test$SEX |> log10(), 
  edgeR.eFDR.2000.train$SEX |> log10(), 
  edgeR.eFDR.2000.test$SEX |> log10(),
  eBayes.eFDR.2000.train$SEX |> log10(), 
  eBayes.eFDR.2000.test$SEX |> log10(),
  voom.eFDR.2000.train$SEX |> log10(), 
  voom.eFDR.2000.test$SEX |> log10()),
                                  Data.type = rep(c("Train", "Test"), each = 2000, times = 5),
                                  DEG.method = rep(c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"), each = 4000)
                                  )
SEX.eFDR.q.dat.2390$DEG.method <- factor(SEX.eFDR.q.dat.2390$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 2390
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/2390/", date.analysis, "_", "SEXMain_eFDR_qvalue", "_", seed.num, ".png"),
       plot = g,
       device = "png",
       width = 8,
       height = 4,
...
MHABNWBC.eFDR.q.dat.2390 <- data.frame(Estimate = c(
  BMAseq.eFDR.Main.2000.train$MHABNWBC |> log10(), 
  BMAseq.eFDR.Main.2000.test$MHABNWBC |> log10(),
  DESeq2.eFDR.2000.train$MHABNWBC |> log10(), 
  DESeq2.eFDR.2000.test$MHABNWBC |> log10(), 
  edgeR.eFDR.2000.train$MHABNWBC |> log10(), 
  edgeR.eFDR.2000.test$MHABNWBC |> log10(),
  eBayes.eFDR.2000.train$MHABNWBC |> log10(), 
  eBayes.eFDR.2000.test$MHABNWBC |> log10(),
  voom.eFDR.2000.train$MHABNWBC |> log10(), 
  voom.eFDR.2000.test$MHABNWBC |> log10()),
                                  Data.type = rep(c("Train", "Test"), each = 2000, times = 5),
                                  DEG.method = rep(c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"), each = 4000)
                                  )
MHABNWBC.eFDR.q.dat.2390$DEG.method <- factor(MHABNWBC.eFDR.q.dat.2390$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 2390
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/2390/", date.analysis, "_", "MHABNWBCMain_eFDR_qvalue", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
BMI.Int.eFDR.q.dat.2390 <- data.frame(
  Estimate = c(
    BMAseq.eFDR.Interaction.2000.train$BMI |> log10(), 
    BMAseq.eFDR.Interaction.2000.test$BMI |> log10(), # same if use $SEX
    DESeq2.eFDR.2000.train$BMIxSEX |> log10(), 
    DESeq2.eFDR.2000.test$BMIxSEX |> log10(), 
    edgeR.eFDR.2000.train$BMIxSEX |> log10(), 
    edgeR.eFDR.2000.test$BMIxSEX |> log10(),
    eBayes.eFDR.2000.train$BMIxSEX |> log10(), 
    eBayes.eFDR.2000.test$BMIxSEX |> log10(),
    voom.eFDR.2000.train$BMIxSEX |> log10(), 
    voom.eFDR.2000.test$BMIxSEX |> log10()),
  Data.type = rep(c("Train", "Test"), each = 2000, times = 5),
  DEG.method = rep(c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"), each = 4000)
                                  )
BMI.Int.eFDR.q.dat.2390$DEG.method <- factor(BMI.Int.eFDR.q.dat.2390$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
g <- BMI.Int.eFDR.q.dat.2390 %>% 
  ...
  labs(x = "Data Type",
       y = "Log10 (estimate)",
       title = "The distributions of top 2000 lowest eFDRs and q-values \nassociated with the interaction effect of BMI X SEX in training and test sets per approach") +
  theme_bw() + 
  theme(plot.title = element_text(hjust = 0.5),
        legend.position = "none") 
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 2390
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/2390/", date.analysis, "_", "BMIInt_eFDR_qvalue", "_", seed.num, ".png"),
       plot = g,
       device = "png",
       width = 8,
       height = 4,
...
BMI.eFDR.q.dat.98907$DEG.method <- factor(BMI.eFDR.q.dat.98907$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 98907
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/98907/", date.analysis, "_", "BMIMain_eFDR_qvalue", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
AGE.eFDR.q.dat.98907$DEG.method <- factor(AGE.eFDR.q.dat.98907$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 98907
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/98907/", date.analysis, "_", "AGEMain_eFDR_qvalue", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
SEX.eFDR.q.dat.98907$DEG.method <- factor(SEX.eFDR.q.dat.98907$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 98907
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/98907/", date.analysis, "_", "SEXMain_eFDR_qvalue", "_", seed.num, ".png"),
       plot = g,
       device = "png",
       width = 8,
       height = 4,
...
MHABNWBC.eFDR.q.dat.98907$DEG.method <- factor(MHABNWBC.eFDR.q.dat.98907$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 98907
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/98907/", date.analysis, "_", "MHABNWBCMain_eFDR_qvalue", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 8,
         height = 4,
...
BMI.Int.eFDR.q.dat.98907$DEG.method <- factor(BMI.Int.eFDR.q.dat.98907$DEG.method, levels = c("BMAseq", "DESeq2", "edgeR", "voom+limma+eBayes", "voom+limma"))
...
date.analysis <- format(Sys.Date(), "%Y%b%d")
seed.num <- 98907
ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/violinplot/98907/", date.analysis, "_", "BMIInt_eFDR_qvalue", "_", seed.num, ".png"),
       plot = g,
       device = "png",
       width = 8,
       height = 4,
...
# Boxplot - gene expression across different states of BMI and SEX
## Seed: 2390 
```{r}
load("../ApplicationData/derived/RandomSeed/VoomLimmaMultiInt2390.RData")
library(ggpubr)
...
# Boxplot - expression distributions of top ranked genes between the training and test set
## Seed: 2390
...
dat.expr.train2390.top9.t$Data <- "Train"
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TrainTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.traintop9 <- names(dat.expr.full2390.traintop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TrainTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", i, "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TrainTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.traintop2 <- names(dat.expr.full2390.traintop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TrainTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
...
##------DESeq2------
load("../ApplicationData/derived/RandomSeed/DESeq2MultiInt2390.RData")
SEX <- c(coldata.train[["SEX"]], coldata.test[["SEX"]])
seed.num <- 2390
date.analysis <- format(Sys.Date(), "%Y%b%d")

for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  temp.ENSG <- DESeq2.eFDR.2000.GeneName.train[["SEX"]][gene.id]
  cts.train2390.top9 <- cts.train[temp.ENSG, ]
  cts.train2390.top9.t <- t(cts.train2390.top9) |> as.data.frame()
  cts.train2390.top9.t$Data <- "Train"
  cts.test2390.traintop9 <- cts.test[temp.ENSG, ]
  cts.test2390.traintop9.t <- t(cts.test2390.traintop9) |> as.data.frame()
  cts.test2390.traintop9.t$Data <- "Test"
  rownames(cts.train2390.top9.t) = rownames(cts.test2390.traintop9.t) = NULL
  dat.expr.full2390.traintop9 <- rbind(cts.train2390.top9.t,
                                       cts.test2390.traintop9.t)
  dat.expr.full2390.traintop9 <- data.frame(dat.expr.full2390.traintop9, SEX)
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TrainTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.traintop9 <- names(dat.expr.full2390.traintop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TrainTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
gene.id <- c(1999, 2000)
temp.ENSG <- DESeq2.eFDR.2000.GeneName.train[["SEX"]][gene.id]
cts.train2390.top2 <- cts.train[temp.ENSG, ]
cts.train2390.top2.t <- t(cts.train2390.top2) |> as.data.frame()
cts.train2390.top2.t$Data <- "Train"
cts.test2390.traintop2 <- cts.test[temp.ENSG, ]
cts.test2390.traintop2.t <- t(cts.test2390.traintop2) |> as.data.frame()
cts.test2390.traintop2.t$Data <- "Test"
rownames(cts.train2390.top2.t) = rownames(cts.test2390.traintop2.t) = NULL
dat.expr.full2390.traintop2 <- rbind(cts.train2390.top2.t,
                                     cts.test2390.traintop2.t)
dat.expr.full2390.traintop2 <- data.frame(dat.expr.full2390.traintop2, SEX)
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TrainTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.traintop2 <- names(dat.expr.full2390.traintop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TrainTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  temp.ENSG <- edgeR.eFDR.2000.GeneName.train[["SEX"]][gene.id]
  dat.expr.train2390.top9 <- dat.expr.train[temp.ENSG, ]
  dat.expr.train2390.top9.t <- t(dat.expr.train2390.top9) |> as.data.frame()
  dat.expr.train2390.top9.t$Data <- "Train"
  dat.expr.test2390.traintop9 <- dat.expr.test[temp.ENSG, ]
  dat.expr.test2390.traintop9.t <- t(dat.expr.test2390.traintop9) |> as.data.frame()
  dat.expr.test2390.traintop9.t$Data <- "Test"
  rownames(dat.expr.train2390.top9.t) = rownames(dat.expr.test2390.traintop9.t) = NULL
  dat.expr.full2390.traintop9 <- rbind(dat.expr.train2390.top9.t,
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TrainTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.traintop9 <- names(dat.expr.full2390.traintop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TrainTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
gene.id <- c(1999, 2000)
temp.ENSG <- edgeR.eFDR.2000.GeneName.train[["SEX"]][gene.id]
dat.expr.train2390.top2 <- dat.expr.train[temp.ENSG, ]
dat.expr.train2390.top2.t <- t(dat.expr.train2390.top2) |> as.data.frame()
dat.expr.train2390.top2.t$Data <- "Train"
dat.expr.test2390.traintop2 <- dat.expr.test[temp.ENSG, ]
dat.expr.test2390.traintop2.t <- t(dat.expr.test2390.traintop2) |> as.data.frame()
dat.expr.test2390.traintop2.t$Data <- "Test"
rownames(dat.expr.train2390.top2.t) = rownames(dat.expr.test2390.traintop2.t) = NULL
dat.expr.full2390.traintop2 <- rbind(dat.expr.train2390.top2.t,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TrainTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.traintop2 <- names(dat.expr.full2390.traintop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TrainTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  dat.expr.train2390.top9 <- dat.expr.train[names(eBayes.eFDR.2000.train[["SEX"]])[gene.id], ]
  dat.expr.train2390.top9.t <- t(dat.expr.train2390.top9) |> as.data.frame()
dat.expr.train2390.top9.t$Data <- "Train"
  dat.expr.test2390.traintop9 <- dat.expr.test[names(eBayes.eFDR.2000.train[["SEX"]])[gene.id], ]
  dat.expr.test2390.traintop9.t <- t(dat.expr.test2390.traintop9) |> as.data.frame()
  dat.expr.test2390.traintop9.t$Data <- "Test"
  rownames(dat.expr.train2390.top9.t) = rownames(dat.expr.test2390.traintop9.t) = NULL
  dat.expr.full2390.traintop9 <- rbind(dat.expr.train2390.top9.t,
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TrainTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.traintop9 <- names(dat.expr.full2390.traintop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TrainTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
gene.id <- c(1999, 2000)
dat.expr.train2390.top2 <- dat.expr.train[names(eBayes.eFDR.2000.train[["SEX"]])[gene.id], ]
dat.expr.train2390.top2.t <- t(dat.expr.train2390.top2) |> as.data.frame()
dat.expr.train2390.top2.t$Data <- "Train"
dat.expr.test2390.traintop2 <- dat.expr.test[names(eBayes.eFDR.2000.train[["SEX"]])[gene.id], ]
dat.expr.test2390.traintop2.t <- t(dat.expr.test2390.traintop2) |> as.data.frame()
dat.expr.test2390.traintop2.t$Data <- "Test"
rownames(dat.expr.train2390.top2.t) = rownames(dat.expr.test2390.traintop2.t) = NULL
dat.expr.full2390.traintop2 <- rbind(dat.expr.train2390.top2.t,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", i, "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TrainTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.traintop2 <- names(dat.expr.full2390.traintop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TrainTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  dat.expr.train2390.top9 <- dat.expr.train[names(voom.eFDR.2000.train[["SEX"]])[gene.id], ]
  dat.expr.train2390.top9.t <- t(dat.expr.train2390.top9) |> as.data.frame()
dat.expr.train2390.top9.t$Data <- "Train"
  dat.expr.test2390.traintop9 <- dat.expr.test[names(voom.eFDR.2000.train[["SEX"]])[gene.id], ]
  dat.expr.test2390.traintop9.t <- t(dat.expr.test2390.traintop9) |> as.data.frame()
  dat.expr.test2390.traintop9.t$Data <- "Test"
  rownames(dat.expr.train2390.top9.t) = rownames(dat.expr.test2390.traintop9.t) = NULL
  dat.expr.full2390.traintop9 <- rbind(dat.expr.train2390.top9.t,
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TrainTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.traintop9 <- names(dat.expr.full2390.traintop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TrainTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
gene.id <- c(1999, 2000)
dat.expr.train2390.top2 <- dat.expr.train[names(voom.eFDR.2000.train[["SEX"]])[gene.id], ]
dat.expr.train2390.top2.t <- t(dat.expr.train2390.top2) |> as.data.frame()
dat.expr.train2390.top2.t$Data <- "Train"
dat.expr.test2390.traintop2 <- dat.expr.test[names(voom.eFDR.2000.train[["SEX"]])[gene.id], ]
dat.expr.test2390.traintop2.t <- t(dat.expr.test2390.traintop2) |> as.data.frame()
dat.expr.test2390.traintop2.t$Data <- "Test"
rownames(dat.expr.train2390.top2.t) = rownames(dat.expr.test2390.traintop2.t) = NULL
dat.expr.full2390.traintop2 <- rbind(dat.expr.train2390.top2.t,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", i, "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TrainTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.traintop2 <- names(dat.expr.full2390.traintop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.traintop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TrainTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
```
...
dat.expr.train2390.testtop9.t$Data <- "Train"
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TestTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TestTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TestTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/BMAseq/TestTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  temp.ENSG <- DESeq2.eFDR.2000.GeneName.test[["SEX"]][gene.id]
  cts.train2390.testtop9 <- cts.test[temp.ENSG, ]
  cts.train2390.testtop9.t <- t(cts.train2390.testtop9) |> as.data.frame()
  cts.train2390.testtop9.t$Data <- "Train"
  cts.test2390.top9 <- cts.test[temp.ENSG, ]
  cts.test2390.top9.t <- t(cts.test2390.top9) |> as.data.frame()
  cts.test2390.top9.t$Data <- "Test"
  rownames(cts.train2390.testtop9.t) = rownames(cts.test2390.top9.t) = NULL
  dat.expr.full2390.testtop9 <- rbind(cts.train2390.testtop9.t,
                                      cts.test2390.top9.t)
  dat.expr.full2390.testtop9 <- data.frame(dat.expr.full2390.testtop9, SEX)
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TestTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.testtop9 <- names(dat.expr.full2390.testtop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.testtop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TestTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
gene.id <- c(1999, 2000)
temp.ENSG <- DESeq2.eFDR.2000.GeneName.train[["SEX"]][gene.id]
cts.train2390.testtop2 <- cts.test[temp.ENSG, ]
cts.train2390.testtop2.t <- t(cts.train2390.testtop2) |> as.data.frame()
cts.train2390.testtop2.t$Data <- "Train"
cts.test2390.top2 <- cts.test[temp.ENSG, ]
cts.test2390.top2.t <- t(cts.test2390.top2) |> as.data.frame()
cts.test2390.top2.t$Data <- "Test"
rownames(cts.train2390.testtop2.t) = rownames(cts.test2390.top2.t) = NULL
dat.expr.full2390.testtop2 <- rbind(cts.train2390.testtop2.t,
                                    cts.test2390.top2.t)
dat.expr.full2390.testtop2 <- data.frame(dat.expr.full2390.testtop2, SEX)
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TestTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.testtop2 <- names(dat.expr.full2390.testtop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.testtop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/DESeq2/TestTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  temp.ENSG <- edgeR.eFDR.2000.GeneName.test[["SEX"]][gene.id]
  dat.expr.train2390.testtop9 <- dat.expr.test[temp.ENSG, ]
  dat.expr.train2390.testtop9.t <- t(dat.expr.train2390.testtop9) |> as.data.frame()
  dat.expr.train2390.testtop9.t$Data <- "Train"
  dat.expr.test2390.top9 <- dat.expr.test[temp.ENSG, ]
  dat.expr.test2390.top9.t <- t(dat.expr.test2390.top9) |> as.data.frame()
  dat.expr.test2390.top9.t$Data <- "Test"
  rownames(dat.expr.train2390.testtop9.t) = rownames(dat.expr.test2390.top9.t) = NULL
  dat.expr.full2390.testtop9 <- rbind(dat.expr.train2390.testtop9.t,
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TestTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  } else {
    boxplot.full2390.testtop9 <- names(dat.expr.full2390.testtop9)[-match(c("Data", "SEX"), names(dat.expr.full2390.testtop9))] |> 
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TestTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
           plot = g, device = "png", width = 16, height = 8, units = "in")
    print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
  }
}
...
gene.id <- c(1999, 2000)
temp.ENSG <- edgeR.eFDR.2000.GeneName.test[["SEX"]][gene.id]
dat.expr.train2390.testtop2 <- dat.expr.test[temp.ENSG, ]
dat.expr.train2390.testtop2.t <- t(dat.expr.train2390.testtop2) |> as.data.frame()
dat.expr.train2390.testtop2.t$Data <- "Train"
dat.expr.test2390.top2 <- dat.expr.test[temp.ENSG, ]
dat.expr.test2390.top2.t <- t(dat.expr.test2390.top2) |> as.data.frame()
dat.expr.test2390.top2.t$Data <- "Test"
rownames(dat.expr.train2390.testtop2.t) = rownames(dat.expr.test2390.top2.t) = NULL
dat.expr.full2390.testtop2 <- rbind(dat.expr.train2390.testtop2.t,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TestTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
} else {
  boxplot.full2390.testtop2 <- names(dat.expr.full2390.testtop2)[-match(c("Data", "SEX"), names(dat.expr.full2390.testtop2))] |> 
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/edgeR/TestTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g, device = "png", width = 16, height = 8, units = "in")
  print(paste0("[", gene.id[1], "] Save a 2-boxplot matrix successfully!"))
}
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  dat.expr.train2390.testtop9 <- dat.expr.train[names(eBayes.eFDR.2000.test[["SEX"]])[gene.id], ]
  dat.expr.train2390.testtop9.t <- t(dat.expr.train2390.testtop9) |> as.data.frame()
dat.expr.train2390.testtop9.t$Data <- "Train"
  dat.expr.test2390.top9 <- dat.expr.test[names(eBayes.eFDR.2000.test[["SEX"]])[gene.id], ]
  dat.expr.test2390.top9.t <- t(dat.expr.test2390.top9) |> as.data.frame()
  dat.expr.test2390.top9.t$Data <- "Test"
  rownames(dat.expr.train2390.testtop9.t) = rownames(dat.expr.test2390.top9.t) = NULL
  dat.expr.full2390.testtop9 <- rbind(dat.expr.train2390.testtop9.t,
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TestTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TestTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
...
gene.id <- c(1999, 2000)
dat.expr.train2390.testtop2 <- dat.expr.train[names(eBayes.eFDR.2000.test[["SEX"]])[gene.id], ]
dat.expr.train2390.testtop2.t <- t(dat.expr.train2390.testtop2) |> as.data.frame()
dat.expr.train2390.testtop2.t$Data <- "Train"
dat.expr.test2390.top2 <- dat.expr.test[names(eBayes.eFDR.2000.test[["SEX"]])[gene.id], ]
dat.expr.test2390.top2.t <- t(dat.expr.test2390.top2) |> as.data.frame()
dat.expr.test2390.top2.t$Data <- "Test"
rownames(dat.expr.train2390.testtop2.t) = rownames(dat.expr.test2390.top2.t) = NULL
dat.expr.full2390.testtop2 <- rbind(dat.expr.train2390.testtop2.t,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TestTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/eBayes/TestTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
...
for(i in seq(1, 1998, 9)) {
  gene.id <- c(i, i + 1, i + 2, i + 3, i + 4, i + 5, i + 6, i + 7, i + 8)
  dat.expr.train2390.testtop9 <- dat.expr.train[names(voom.eFDR.2000.test[["SEX"]])[gene.id], ]
  dat.expr.train2390.testtop9.t <- t(dat.expr.train2390.testtop9) |> as.data.frame()
dat.expr.train2390.testtop9.t$Data <- "Train"
  dat.expr.test2390.top9 <- dat.expr.test[names(voom.eFDR.2000.test[["SEX"]])[gene.id], ]
  dat.expr.test2390.top9.t <- t(dat.expr.test2390.top9) |> as.data.frame()
  dat.expr.test2390.top9.t$Data <- "Test"
  rownames(dat.expr.train2390.testtop9.t) = rownames(dat.expr.test2390.top9.t) = NULL
  dat.expr.full2390.testtop9 <- rbind(dat.expr.train2390.testtop9.t,
  ...
  if ((!is.na(sumDis)) & (sumDis > 0)) {
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TestTop2000/Discordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TestTop2000/Concordant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
...
gene.id <- c(1999, 2000)
dat.expr.train2390.testtop2 <- dat.expr.train[names(voom.eFDR.2000.test[["SEX"]])[gene.id], ]
dat.expr.train2390.testtop2.t <- t(dat.expr.train2390.testtop2) |> as.data.frame()
dat.expr.train2390.testtop2.t$Data <- "Train"
dat.expr.test2390.top2 <- dat.expr.test[names(voom.eFDR.2000.test[["SEX"]])[gene.id], ]
dat.expr.test2390.top2.t <- t(dat.expr.test2390.top2) |> as.data.frame()
dat.expr.test2390.top2.t$Data <- "Test"
rownames(dat.expr.train2390.testtop2.t) = rownames(dat.expr.test2390.top2.t) = NULL
dat.expr.full2390.testtop2 <- rbind(dat.expr.train2390.testtop2.t,
...
if ((!is.na(sumDis)) & (sumDis > 0)) {
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TestTop2000/Discordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.testtop2, ncol = 2)))
  print(paste0("[", gene.id[1], "] Plot a 2-boxplot matrix successfully!"))
  ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/SEX/voom/TestTop2000/Concordant/", date.analysis, "_", gene.id[1], "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,

---
title: "Multi-model BMAseq and other single-model approaches (DESeq2, edgeR, limma) on inferring robust differentially expressed genes"
author: "Anni Liu"
...
g2 <- duplicate_rate_bmi |>
  ...
  labs(y = "Mean duplicate rate of cDEGs", x = "Method", color = "Threshold") + 
  theme(legend.position = "right")

ggsave(filename = sprintf("../ApplicationResult/AddViz/DuplicatedRate/%s_mean_each_threshold.eps", date.analysis),
       plot = g2, device = "eps", dpi = 600, width = 5, height = 5, units = "in")
```

...
easypackages::libraries("BMAseq", "limma", "qvalue", "parallel", "tidyverse", "edgeR", "DESeq2", "data.table", "ggVennDiagram", "gridExtra", "openxlsx") |> suppressPackageStartupMessages()
...
make_vennplot <-function(var.name = NULL, threshold = NULL) {
  ...
  ggsave(filename = paste0("../ApplicationResult/Uni/RandomSeed/TMM_Top2000/Vennplot/", date.analysis, "_", var.name, "_", seed.i, ".eps"),
         plot = g,
         device = "eps",
         dpi = 600, 
         width = 10,
...
make_vennplot <-function(var.name = NULL, threshold = NULL) {
  ...
  ggsave(filename = paste0("../ApplicationResult/Multi/RandomSeed/TMM_Top2000/Vennplot/", date.analysis, "_", var.name, "_", seed.i, ".eps"),
         plot = g,
         device = "eps",
         dpi = 600, 
         width = 10,
...
## Contruct Gene Set Enrichment Analysis (GSEA)
```{r}
```
...
## [Optional] Make cDEGs rate line plots grouped by random seeds
```{r}
##------Preprocess data------
cDEGs_rate_uni <- readRDS("../ApplicationResult/Uni/RandomSeed/ratecDEGs/Boxplot/boxplot.data.rate.BMA.RDS")
cDEGs_rate_uni <- cDEGs_rate_uni[cDEGs_rate_uni$method!="BMAseq", ]

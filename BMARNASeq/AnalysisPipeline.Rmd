...
ggsave(filename = sprintf("../ApplicationResult/Multi_Interaction/RandomSeed/DuplicatedRateMatrix/Boxplot/%s_median.png", date.analysis),
       plot = g1, device = "png", width = 5, height = 4, units = "in")
...
ggsave(filename = sprintf("../ApplicationResult/Multi_Interaction/RandomSeed/DuplicatedRateMatrix/Boxplot/%s_mean.png", date.analysis),
       plot = g2, device = "png", width = 5, height = 4, units = "in")
```
...
for (var.i in var.vec) {
  g <- cDEGs_num_all[variable==var.i] |>
    ...
    theme(legend.position = "none",
          axis.text.x = element_text(size = 9, angle = 90, hjust = 1, color = "black", vjust = 0.5))
    ggsave(filename = sprintf("../ApplicationResult/AddViz/numcDEGs/%s_%s.png", date.analysis, var.i),
           plot = g, device = "png", width = 9, height = 6, units = "in")
}
```
  ...
  if (var.i != "MHABNWBC") {
    g <- cDEGs_rate_all[variable==var.i] |>
      ...
      theme(legend.position = "none",
            axis.text.x = element_text(size = 9, angle = 90, hjust = 1, color = "black", vjust = 0.5)) +
      scale_y_continuous(labels = scales::label_number(accuracy = 0.01), breaks = seq(0, 0.5, 0.1), limits = c(0, 0.5))
    ggsave(filename = sprintf("../ApplicationResult/AddViz/ratecDEGs/%s_%s.png", date.analysis, var.i),
             plot = g, device = "png", width = 9, height = 6, units = "in")
  } else {
    g <- cDEGs_rate_all[variable==var.i] |>
      ggplot(aes(y = rate.cDEGs, x = method, group = method)) + 
  ...
  if (var.i != "MHABNWBC") {
    g <- cDEGs_rate_all[variable==var.i] |>
      ...
      theme(# legend.position = "none",
            axis.text.x = element_text(size = 9, angle = 90, hjust = 1, color = "black", vjust = 0.5)) +
      scale_y_continuous(labels = scales::label_number(accuracy = 0.01), breaks = seq(0, 0.5, 0.1), limits = c(0, 0.5))
    ggsave(filename = sprintf("../ApplicationResult/AddViz/ratecDEGs/%s_%s_line.png", date.analysis, var.i),
             plot = g, device = "png", width = 9, height = 6, units = "in")
  } else {
    g <- cDEGs_rate_all[variable==var.i] |>
      ggplot(aes(y = rate.cDEGs, x = method, group = random.seed)) + 
  ...
  if (var.i != "MHABNWBC") {
    g <- cDEGs_rate_all[variable==var.i] |>
      ...
      theme(# legend.position = "none",
            axis.text.x = element_text(size = 9, angle = 90, hjust = 1, color = "black", vjust = 0.5)) +
      scale_y_continuous(labels = scales::label_number(accuracy = 0.01), breaks = seq(0, 0.5, 0.1), limits = c(0, 0.5))
    ggsave(filename = sprintf("../ApplicationResult/AddViz/ratecDEGs/%s_%s_line_box.png", date.analysis, var.i),
             plot = g, device = "png", width = 9, height = 6, units = "in")
  } else {
    g <- cDEGs_rate_all[variable==var.i] |>
      ggplot(aes(y = rate.cDEGs, x = method, group = random.seed)) + 
...
g1 <- duplicate_rate_all |>
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(size = 9, angle = 90, hjust = 1, color = "black", vjust = 0.5))
ggsave(filename = sprintf("../ApplicationResult/AddViz/DuplicatedRate/%s_median.png", date.analysis),
       plot = g1, device = "png", width = 9, height = 6, units = "in")
...
g2 <- duplicate_rate_all |>
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(size = 9, angle = 90, hjust = 1, color = "black", vjust = 0.5))
ggsave(filename = sprintf("../ApplicationResult/AddViz/DuplicatedRate/%s_mean.png", date.analysis),
       plot = g2, device = "png", width = 9, height = 6, units = "in")
```

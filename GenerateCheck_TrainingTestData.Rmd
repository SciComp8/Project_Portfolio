...
dat.expr.train2390.top9.t$Data <- "Train"
  ...
  if (any(!is.na(p.vec) & p.vec < 0.05)) {
    ...
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/Significant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
  ...
  print(paste0("[", i, "] Save a 9-boxplot matrix successfully!"))
    ...
    g <- grid.arrange(do.call("arrangeGrob", c(boxplot.full2390.traintop9, ncol = 3)))
    print(paste0("[", i, "] Plot a 9-boxplot matrix successfully!"))
    ggsave(filename = paste0("../ApplicationResult/Multi_Interaction/RandomSeed/TMM_Top2000/Boxplot/2390/Insignificant/", date.analysis, "_", i, "GeneExpBoxplotTrainTest", "_", seed.num, ".png"),
         plot = g,
         device = "png",
         width = 16,
         height = 8,
